                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        ...
                        <form class="forms-sample" method="post" action="{{url('upload_user')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control"type="text" id="email"  name="email" placeholder="">
                            
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control"type="text" id="password"  name="password" placeholder="">
                            
                            </div>
                            <div class="form-group">
                                <label for="address">Address</label>
                                <input type="text" class="form-control"type="text" id="address"  name="address" placeholder="">
